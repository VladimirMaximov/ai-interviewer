...
class Settings(BaseSettings):
    ...
    proctoring_embedding_cache: str = "apps/api/models/speechbrain-spkrec-ecapa"
    ...
    whisper_cpp_model: str = "apps/api/models/ggml-small.bin"
    ffmpeg_binary: str = "ffmpeg"
    question_speech_provider: Literal["browser", "silero", "xtts"] = "browser"
    silero_voice: str = "aidar"
    silero_helper: str = "apps/api/scripts/silero_tts.py"
    ...
    presenter_portrait_path: str = "apps/api/assets/avatar/interviewer-cutout.png"
